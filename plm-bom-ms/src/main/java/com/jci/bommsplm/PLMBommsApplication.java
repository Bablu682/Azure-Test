...
import com.jci.bommsplm.service.PLMBomMSService;
...
public class PLMBommsApplication {
	...
	@Autowired
	private PLMBomMSService bomservice;
	...
	public String bomCircuitBreaker() {
		String value = bomservice.hystrixCircuitBreaker();
		return value;
